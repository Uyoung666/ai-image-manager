...
export const updateAlbum = os
  ...
  .handler(async ({ input }) => {
    ...
    if (fields.coverPhotoId !== undefined) updates.coverPhotoId = fields.coverPhotoId;
    if (fields.isSmart !== undefined) updates.isSmart = fields.isSmart;
    if (fields.smartRules !== undefined) updates.smartRules = fields.smartRules;
