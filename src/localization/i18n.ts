  ...
  resources: {
    zh: {
      translation: {
        ...
        sequenceMoveSuccess: "已调整序列顺序",
        sequenceMoveFailed: "调整序列顺序失败，已恢复原顺序",
        sequenceMoving: "正在调整顺序…",
        sequenceMoved: "顺序已更新",
        ...
        settingsPlugins: "插件",
        settingsPluginsDescription:
          "安装声明式主题插件，并管理可逆的界面效果。",
        settingsPluginsInstall: "安装插件",
        settingsPluginsInstalled: "已安装插件",
        settingsPluginsConfiguration: "插件配置",
        settingsPluginsConfigurationHint:
          "调整当前启用插件的材质、背景和本地资源。",
        settingsPluginsSafety:
          "插件包只允许主题令牌、设置和图片/视频资源，不执行第三方代码。",
        settingsPluginsEmpty: "还没有安装插件。",
        settingsPluginsEnable: "启用插件",
        settingsPluginsUninstall: "卸载插件",
        settingsPluginsIncompatible: "与当前应用版本不兼容",
        settingsPluginsChooseImage: "选择图片",
        settingsPluginsChooseVideo: "选择视频",
        settingsPluginsReplaceFile: "更换文件",
        settingsPluginsBuiltin: "内置",
        settingsPluginsLocal: "本地导入",
        settingsPluginsFailed: "运行失败，已回退原生主题",
        settingsPluginsInvalid: "插件包校验失败",
        pluginManagerTitle: "插件管理",
        pluginManagerInstall: "安装插件",
        pluginManagerDescription:
          "安装和预览声明式主题插件，所有公开插件都在本地安全边界内运行。",
        pluginManagerListTitle: "已安装插件",
        pluginManagerEmpty: "还没有安装插件。",
        pluginManagerSelectHint: "从左侧选择一个插件查看概览、配置和诊断。",
        pluginManagerAuthor: "作者",
        pluginManagerVersion: "版本",
        pluginManagerSource: "来源",
        pluginManagerSourceBuiltin: "内置",
        pluginManagerSourceLocal: "本地导入",
        pluginManagerSourceDeveloper: "开发目录",
        pluginManagerTrust: "信任",
        pluginManagerTrustTrusted: "应用内置",
        pluginManagerTrustUnsigned: "未签名声明式",
        pluginManagerTrustDeveloper: "开发模式",
        pluginManagerStatus: "状态",
        pluginManagerStatusActive: "运行中",
        pluginManagerStatusDisabled: "已停用",
        pluginManagerStatusIncompatible: "不兼容",
        pluginManagerStatusInvalid: "无效",
        ...
        pluginManagerNoConfiguration: "此插件没有可配置的设置。",
        pluginManagerDiagnostics: "诊断",
        pluginManagerPluginId: "插件 ID",
        pluginManagerError: "错误",
        pluginManagerNoDiagnostics: "没有诊断错误。",
        pluginManagerNotAvailable: "暂无",
        pluginManagerPreview: "预览",
        pluginManagerExitPreview: "退出预览",
        pluginManagerPreviewBanner: "正在预览 {{name}}",
        pluginManagerActivePlugin: "当前插件：{{name}}",
        pluginManagerEnable: "启用",
        pluginManagerToggle: "切换插件",
        pluginManagerIconFallback: "插件图标占位",
        pluginManagerUninstall: "卸载插件",
        pluginManagerUninstallTitle: "卸载 {{name}}？",
        pluginManagerUninstallDescription:
          "卸载后插件将从应用中移除；你可以选择是否同时清理配置和托管资源。",
        pluginManagerRemoveData: "同时清理配置和托管资源",
        pluginManagerUninstallCancel: "取消",
        pluginManagerUninstallConfirm: "卸载",
        pluginManagerInstallTitle: "安装前检查",
        pluginManagerInstallConfirm: "确认安装",
        pluginManagerInstallCancel: "取消",
        pluginManagerPackageSize: "包大小",
        pluginManagerChecksum: "校验摘要",
        pluginManagerInstallRelation: "安装关系",
        pluginManagerInstallNew: "新插件",
        pluginManagerInstallUpgrade: "升级（当前 {{version}}）",
        pluginManagerInstallDowngrade: "降级（当前 {{version}}）",
        pluginManagerInstallReplace: "替换现有版本",
        pluginManagerInstallBlocked: "此插件与当前应用版本不兼容。",
        pluginManagerUnsignedWarning:
          "这是未签名的本地声明式插件；公开插件不会执行 JavaScript、HTML、CSS 或网络请求。",
        pluginManagerDeveloperMode: "开发者模式",
        pluginManagerDeveloperDirectory: "开发目录",
        pluginManagerLoadDirectory: "加载开发目录",
        pluginManagerReloadDeveloper: "重新加载开发插件",
        pluginManagerRemoveDeveloper: "移除开发插件",
        pluginManagerRefresh: "手动刷新",
        pluginSettingsRemoveAsset: "移除",
        pluginSettingsResetAll: "全部重置",
        pluginSettingsResetGroup: "重置分组",
        pluginSettingsResetSetting: "重置此项",
        ...
        wander: {
          ...
          hamsterWheelControlsHint: "移动鼠标显示控制 · 空格暂停 · Esc 退出",
          paused: "已暂停",
          progress: "漫游进度",
          loadFailed: "暂时无法开始漫游",
        ...
        migratingData: "正在切换数据目录...",
        dataMigratedTo: "数据已迁移到 {{path}}",
        existingDataLoadedFrom: "已载入 {{path}} 中的已有图库",
        ...
        watermarkEnableHint: "水印会应用到照片导出结果中。",
        watermarkLivePreview: "实时预览",
        watermarkPreviewSample: "预览样例",
        watermarkPreviewCanvasLabel: "水印实时预览，可拖动水印调整位置",
        watermarkNoPreviewPhoto: "暂无可预览的照片",
        watermarkPreviewDisabled: "预览中，未启用导出",
        watermarkContent: "水印内容",
        watermarkContentHint: "选择一种水印类型，另一种类型的内容会保留。",
        watermarkType: "水印类型",
        watermarkTextMode: "文字水印",
        watermarkImageMode: "图片水印",
        watermarkText: "水印文字",
        watermarkTextPlaceholder: "例如: © 2026 Your Name",
        watermarkTextEmptyHint: "输入文字后即可在预览中查看效果。",
        watermarkImage: "图片水印",
        watermarkImageFile: "图片文件",
        watermarkChooseImage: "选择图片文件",
        watermarkImageClearedHint: "未选择图片，文字水印内容仍会保留。",
        watermarkChangeImageHint: "点击更换图片",
        watermarkImageFormats: "支持 PNG、JPG、WebP 和 SVG",
        watermarkAssetReady: "已就绪",
        watermarkAssetLoading: "正在读取图片…",
        watermarkAssetError: "图片无法读取，请重新选择或清除。",
        watermarkImageScale: "图片大小 {{value}}%",
        orDragPreview: "或在预览中拖动",
        dragToPosition: "拖到目标位置",
        watermarkStyle: "样式",
        watermarkStyleHint: "调整水印大小和透明度。",
        ...
        watermarkPositionHint: "拖动预览可快速定位，也可以使用九宫格精确选择。",
        watermarkResetPosition: "重置位置",
        positionTopLeft: "左上",
        positionTopRight: "右上",
        ...
        onboardingStep1Migrating: "正在切换数据目录...",
        ...
        onboardingErrorMigration: "数据目录切换失败：{{error}}",
    ...
    en: {
      translation: {
        ...
        sequenceMoveSuccess: "Sequence order updated",
        sequenceMoveFailed:
          "Unable to update sequence order; restored the previous order",
        sequenceMoving: "Updating order…",
        ...
        settingsPluginsDescription:
          "Install declarative theme plugins and manage reversible interface effects.",
        settingsPluginsInstall: "Install plugin",
        settingsPluginsInstalled: "Installed plugins",
        settingsPluginsConfiguration: "Plugin configuration",
        settingsPluginsConfigurationHint:
          "Adjust the active plugin's material, backdrop, and local assets.",
        settingsPluginsSafety:
          "Plugin packages may contain theme tokens, settings, and image/video assets only; third-party code is never executed.",
        settingsPluginsEmpty: "No plugins installed yet.",
        settingsPluginsEnable: "Enable plugin",
        settingsPluginsUninstall: "Uninstall plugin",
        settingsPluginsIncompatible: "Incompatible with this app version",
        settingsPluginsChooseImage: "Choose image",
        settingsPluginsChooseVideo: "Choose video",
        settingsPluginsReplaceFile: "Replace file",
        settingsPluginsBuiltin: "Built-in",
        settingsPluginsLocal: "Local import",
        settingsPluginsFailed: "Runtime failure; reverted to the native theme",
        settingsPluginsInvalid: "Plugin package validation failed",
        pluginManagerTitle: "Plugin manager",
        pluginManagerInstall: "Install plugin",
        pluginManagerDescription:
          "Install and preview declarative theme plugins within a local safety boundary.",
        pluginManagerListTitle: "Installed plugins",
        pluginManagerEmpty: "No plugins installed yet.",
        pluginManagerSelectHint:
          "Select a plugin on the left to see its overview, configuration, and diagnostics.",
        pluginManagerAuthor: "Author",
        pluginManagerVersion: "Version",
        pluginManagerSource: "Source",
        pluginManagerSourceBuiltin: "Built-in",
        pluginManagerSourceLocal: "Local import",
        pluginManagerSourceDeveloper: "Developer directory",
        pluginManagerTrust: "Trust",
        pluginManagerTrustTrusted: "App-provided",
        pluginManagerTrustUnsigned: "Unsigned declarative",
        pluginManagerTrustDeveloper: "Developer mode",
        pluginManagerStatus: "Status",
        pluginManagerStatusActive: "Active",
        pluginManagerStatusDisabled: "Disabled",
        pluginManagerStatusIncompatible: "Incompatible",
        pluginManagerStatusInvalid: "Invalid",
        ...
        pluginManagerNoConfiguration:
          "This plugin has no configurable settings.",
        pluginManagerDiagnostics: "Diagnostics",
        pluginManagerPluginId: "Plugin ID",
        pluginManagerError: "Error",
        pluginManagerNoDiagnostics: "No diagnostic errors.",
        pluginManagerNotAvailable: "Not available",
        pluginManagerPreview: "Preview",
        pluginManagerExitPreview: "Exit preview",
        pluginManagerPreviewBanner: "Previewing {{name}}",
        pluginManagerActivePlugin: "Active plugin: {{name}}",
        pluginManagerEnable: "Enable",
        pluginManagerToggle: "Toggle plugin",
        pluginManagerIconFallback: "Plugin icon placeholder",
        pluginManagerUninstall: "Uninstall plugin",
        pluginManagerUninstallTitle: "Uninstall {{name}}?",
        pluginManagerUninstallDescription:
          "The plugin will be removed from the app. You can also remove its configuration and managed resources.",
        pluginManagerRemoveData:
          "Also remove configuration and managed resources",
        pluginManagerUninstallCancel: "Cancel",
        pluginManagerUninstallConfirm: "Uninstall",
        pluginManagerInstallTitle: "Install preflight",
        pluginManagerInstallConfirm: "Confirm install",
        pluginManagerInstallCancel: "Cancel",
        pluginManagerPackageSize: "Package size",
        pluginManagerChecksum: "Checksum summary",
        pluginManagerInstallRelation: "Install relation",
        pluginManagerInstallNew: "New plugin",
        pluginManagerInstallUpgrade: "Upgrade (current {{version}})",
        pluginManagerInstallDowngrade: "Downgrade (current {{version}})",
        pluginManagerInstallReplace: "Replace existing version",
        pluginManagerInstallBlocked:
          "This plugin is incompatible with the current app version.",
        pluginManagerUnsignedWarning:
          "This is an unsigned local declarative plugin; public plugins execute no JavaScript, HTML, CSS, or network requests.",
        pluginManagerDeveloperMode: "Developer mode",
        pluginManagerDeveloperDirectory: "Developer directory",
        pluginManagerLoadDirectory: "Load developer directory",
        pluginManagerReloadDeveloper: "Reload developer plugin",
        pluginManagerRemoveDeveloper: "Remove developer plugin",
        pluginManagerRefresh: "Refresh manually",
        pluginSettingsRemoveAsset: "Remove",
        pluginSettingsResetAll: "Reset all",
        pluginSettingsResetGroup: "Reset group",
        pluginSettingsResetSetting: "Reset setting",
        ...
        wander: {
          ...
          subtitle: {
            ...
            hamsterWheel: "Let it run for a while",
          },
        ...
        migratingData: "Switching data directory...",
        dataMigratedTo: "Data migrated to {{path}}",
        existingDataLoadedFrom: "Loaded the existing library from {{path}}",
        ...
        watermarkTextEmptyHint: "Enter text to preview the watermark.",
        watermarkImage: "Image watermark",
        watermarkImageFile: "Image file",
        watermarkChooseImage: "Choose an image file",
        watermarkImageClearedHint:
          "No image selected; your text watermark is still preserved.",
        watermarkChangeImageHint: "Click to replace the image",
        ...
        watermarkStyleHint: "Adjust watermark size and opacity.",
        ...
        addTag: "Add",
        tagPickerViewAll: "View all ({{count}})",
        tagPickerCollapse: "Show fewer",
        tagPickerMatches: "{{count}} existing tag(s) found",
        tagPickerNoMatches: "No existing tags found",
        tagPickerAlreadyAdded: "Added",
        aiSuggestionConfirm:
        ...
        faceReviewNoPending: "No faces need review",
        ...
        aiTagsNoPhotos: "No photos are available for tag generation",
        ...
        onboardingStep1Migrating: "Switching data directory...",
        ...
        onboardingErrorMigration: "Failed to switch data directory: {{error}}",
