  ...
  resources: {
    zh: {
      translation: {
        ...
        quickPreviewHelp: "Space / Esc 关闭 · ← → 切换 · 滚轮缩放 · 双击还原",
    ...
    en: {
      translation: {
        ...
        noFocalData: "No focal length data yet. Please import photos with EXIF data first.",
        ...
        noApertureData: "No aperture data yet. Please import photos with EXIF data first.",
        isoDistributionTitle: "ISO Distribution",
        noIsoData: "No ISO data yet. Please import photos with EXIF data first.",
        timeDistribution24h: "24-hour Shooting Distribution",
        noTimeData: "No shooting time data yet. Please import photos with EXIF data first.",
        noShutterData: "No shutter speed data yet. Please import photos with EXIF data first.",
        noYearData: "No shooting year data yet. Please import photos with EXIF data first.",
        noMonthData: "No shooting month data yet. Please import photos with EXIF data first.",
        ...
        clearAll: "Clear all",
        drillDownActiveHint: "Drilled down from dashboard. You can add more filters below.",
        ...
        shortcutGlobalFocusSearch: "Bring up window & focus search from anywhere",
