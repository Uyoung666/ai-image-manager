  ...
  resources: {
    zh: {
      translation: {
        ...
        noApertureData: "暂无光圈数据",
        isoDistributionTitle: "ISO 分布",
        noIsoData: "暂无 ISO 数据",
        timeDistribution24h: "24小时拍摄分布",
        noTimeData: "暂无拍摄时间数据",
        noShutterData: "暂无快门速度数据",
        noYearData: "暂无拍摄年份数据",
        noMonthData: "暂无拍摄月份数据",
    ...
    en: {
      translation: {
        ...
        noApertureData: "No aperture data yet.",
        isoDistributionTitle: "ISO Distribution",
        noIsoData: "No ISO data yet.",
        timeDistribution24h: "24-hour Shooting Distribution",
        noTimeData: "No shooting time data yet.",
        noShutterData: "No shutter speed data yet.",
        noYearData: "No shooting year data yet.",
        noMonthData: "No shooting month data yet.",
