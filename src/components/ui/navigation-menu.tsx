...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      data-overlay-kind="navigation-menu"
  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        data-surface="overlay"
        className={cn(
          "origin-top-center relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-xl bg-popover text-popover-foreground ring-1 ring-foreground/10 duration-100 md:w-(--radix-navigation-menu-viewport-width) data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-95",
          className
        )}
        {...props}
      />
