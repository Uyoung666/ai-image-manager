...
**Installer (Recommended):** `AI Image Manager-1.1.0 Setup.exe` — installs to `%LocalAppData%`, creates shortcuts, auto-updates.

**Portable:** `AI Image Manager-win32-x64-1.1.0.zip` — extract anywhere, run directly, no registry writes.
