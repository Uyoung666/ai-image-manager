...
**Installer (Recommended):** `AI Image Manager-1.3.1 Setup.exe` — installs to `%LocalAppData%`, creates shortcuts, auto-updates.

**Portable:** `AI Image Manager-win32-x64-1.3.1.zip` — extract anywhere, run directly, no registry writes.
